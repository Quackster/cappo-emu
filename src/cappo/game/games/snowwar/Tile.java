...
public class Tile
{
  ...
  public static int _1L = (int)Math.sqrt(TILE_SIZE * TILE_SIZE + TILE_SIZE * TILE_SIZE);
  ...
  {
    this._3ob = new Tile[8];
    this._4gH = new int[] { _arg1, _arg2 };
    this._location = new PlayerTile(_arg1 * TILE_SIZE, _arg2 * TILE_SIZE, 0);
    this._0E8 = new ArrayList();
  }
  
  public static int _4mC(int _arg1)
  {
    return MathUtil._43Z((_arg1 + _37G) / TILE_SIZE);
  }
  ...
  {
    this._0E8.add(fuseItem);
    _4AO((int)(fuseItem.baseItem.Height * TILE_SIZE));
  }
  ...
  {
    int local1 = this._location.x() - _arg1.x();
    if (local1 < 0) {
      local1 = -local1;
    }
    int local2 = this._location.y() - _arg1.y();
    if (local2 < 0) {
      local2 = -local2;
    }
  ...
  {
    this._3ob[_arg2.getRot()] = _arg1;
  }
  
  public Tile getNextTileAtRot(Direction8 _arg1)
  {
    return this._3ob[_arg1.getRot()];
  }
  ...
  public boolean isOpen(GameItemObject _arg1)
  {
    ...
    if (this._0E8.size() == 1) {
      isBlocked = !((GamefuseObject)this._0E8.get(0)).baseItem.allowWalk;
    } else if (!this._0E8.isEmpty()) {
      isBlocked = true;
    }
    return (!isBlocked) && (this._0Zr == null) && (!this.blocked);
  }
  ...
  {
    if ((this._0Zr != null) && ((this._0Zr instanceof HumanGameObject))) {
      return (HumanGameObject)this._0Zr;
    }
    return null;
  }
  ...
  {
    return this._location.distanceTo(_arg1.location());
  }
  
  public Direction8 directionTo(Tile _arg1)
  {
    return this._location.directionTo(_arg1.location());
  }
